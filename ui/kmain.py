...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        # Placeholder row for the oplog search bar (inserted by kmainForm)
        self.oplogSearchPlaceholder = QtWidgets.QWidget(self.tab_3)
        self.oplogSearchPlaceholder.setObjectName("oplogSearchPlaceholder")
        self.gridLayout_3.addWidget(self.oplogSearchPlaceholder, 1, 0, 1, 1)
        ...
        # Placeholder row for the outlog search bar (inserted by kmainForm)
        self.outlogSearchPlaceholder = QtWidgets.QWidget(self.tab_5)
        self.outlogSearchPlaceholder.setObjectName("outlogSearchPlaceholder")
        self.gridLayout_2.addWidget(self.outlogSearchPlaceholder, 1, 0, 1, 1)
        ...
        self.actionFridaStop = QtWidgets.QAction(MainWindow)
        self.actionFridaStop.setObjectName("actionFridaStop")
        self.actionFrida32Stop = QtWidgets.QAction(MainWindow)
        self.actionFrida32Stop.setObjectName("actionFrida32Stop")
        self.actionFrida64Stop = QtWidgets.QAction(MainWindow)
        self.actionFrida64Stop.setObjectName("actionFrida64Stop")
        self.actionFridax86Stop = QtWidgets.QAction(MainWindow)
        self.actionFridax86Stop.setObjectName("actionFridax86Stop")
        self.actionFridax64Stop = QtWidgets.QAction(MainWindow)
        self.actionFridax64Stop.setObjectName("actionFridax64Stop")
        ...
        self.actionVer17 = QtWidgets.QAction(MainWindow)
        self.actionVer17.setCheckable(True)
        self.actionVer17.setObjectName("actionVer17")
        ...
        self.actionRefreshDevices = QtWidgets.QAction(MainWindow)
        self.actionRefreshDevices.setObjectName("actionRefreshDevices")
        self.actionRefreshFridaVer = QtWidgets.QAction(MainWindow)
        self.actionRefreshFridaVer.setObjectName("actionRefreshFridaVer")
        self.actionFridaLibVer = QtWidgets.QAction(MainWindow)
        self.actionFridaLibVer.setEnabled(False)
        self.actionFridaLibVer.setObjectName("actionFridaLibVer")
        self.actionFridaClientVer = QtWidgets.QAction(MainWindow)
        self.actionFridaClientVer.setEnabled(False)
        self.actionFridaClientVer.setObjectName("actionFridaClientVer")
        self.actionFridaToolsVer = QtWidgets.QAction(MainWindow)
        self.actionFridaToolsVer.setEnabled(False)
        self.actionFridaToolsVer.setObjectName("actionFridaToolsVer")
        self.actionFridaServerVer = QtWidgets.QAction(MainWindow)
        self.actionFridaServerVer.setEnabled(False)
        self.actionFridaServerVer.setObjectName("actionFridaServerVer")
        ...
        self.menu_frida_server.addSeparator()
        self.menu_frida_server.addAction(self.actionFridaStop)
        self.menu_frida_server.addAction(self.actionFrida32Stop)
        self.menu_frida_server.addAction(self.actionFrida64Stop)
        self.menu_frida_server.addAction(self.actionFridax86Stop)
        self.menu_frida_server.addAction(self.actionFridax64Stop)
        ...
        self.menufrida.addAction(self.actionVer17)
        self.menufrida.addSeparator()
        self.menufrida.addAction(self.actionRefreshFridaVer)
        self.menufrida.addSeparator()
        self.menufrida.addAction(self.actionFridaLibVer)
        self.menufrida.addAction(self.actionFridaClientVer)
        self.menufrida.addAction(self.actionFridaToolsVer)
        self.menufrida.addAction(self.actionFridaServerVer)
        self.menu_3.addAction(self.actionChina)
        self.menu_3.addAction(self.actionEnglish)
        self.menuDevice.addAction(self.actionRefreshDevices)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionFrida32Start.setText(_translate("MainWindow", "start frida-server (arm)"))
        self.actionFrida64Start.setText(_translate("MainWindow", "start frida-server (arm64)"))
        self.actionFridax86Start.setText(_translate("MainWindow", "start frida-server (x86)"))
        self.actionFridax64Start.setText(_translate("MainWindow", "start frida-server (x64)"))
        self.actionFridaStop.setText(_translate("MainWindow", "stop frida-server (all)"))
        self.actionFrida32Stop.setText(_translate("MainWindow", "stop frida-server (arm)"))
        self.actionFrida64Stop.setText(_translate("MainWindow", "stop frida-server (arm64)"))
        self.actionFridax86Stop.setText(_translate("MainWindow", "stop frida-server (x86)"))
        self.actionFridax64Stop.setText(_translate("MainWindow", "stop frida-server (x64)"))
        ...
        self.actionFridaClientVer.setText(_translate("MainWindow", "frida client: (checking...)"))
        self.actionFridaToolsVer.setText(_translate("MainWindow", "frida-tools: (checking...)"))
        self.actionFridaServerVer.setText(_translate("MainWindow", "frida server: (checking...)"))
